...
ggplot(newdata, aes(x = agep, y = prob, color = hincp_label, fill = hincp_label)) +
  ...
  labs(
    ...
    subtitle = "Higher income and younger people are more likely to have full\ninternet access; the effect of income on access increases with\nage.",
